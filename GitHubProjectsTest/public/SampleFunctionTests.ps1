...
function GitHubProjectsTest_GetPublicString{ 
...
function GitHubProjectsTest_GetPrivateString {

    $testedModulePath =  $TESTED_MODULE_PATH | Join-Path -ChildPath "GitHubProjects.psd1"
...
Export-ModuleMember -Function GitHubProjectsTest_*
